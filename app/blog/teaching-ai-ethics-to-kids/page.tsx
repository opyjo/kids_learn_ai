			...
			<article className="container mx-auto px-4 py-20 lg:py-28">
				<div className="max-w-3xl mx-auto">
					...
					<p className="text-muted-foreground text-lg leading-relaxed mb-10">
						As AI becomes a constant companion in children's lives, technical
					...
					<section className="space-y-6 mb-12">
						...
						<p className="text-muted-foreground leading-relaxed">
							Many parents worry that "ethics" is too abstract for children.
							However, kids have a naturally strong sense of fairness. By
							framing AI bias as a "fairness" issue—like a computer that only
							knows about apples being asked to identify a banana—we can make
							complex concepts relatable and memorable.
						</p>
					</section>
					...
					<section className="space-y-6 mb-12">
						...
						<p className="text-muted-foreground leading-relaxed">
							We encourage parents to look for "teachable moments" in everyday
							life. If a voice assistant doesn't understand an accent, or a
							search engine suggests a specific stereotype, don't ignore it. Ask
							your child: "Why do you think the computer made that mistake? What
							was it missing from its training?"
						</p>
					</section>
					...
					<section className="bg-secondary/30 rounded-3xl p-8 mb-16">
						...
						<p className="text-muted-foreground leading-relaxed">
							At Kids Learn AI, we don't just teach kids how to build models; we
							teach them how to build *better* models. Our students learn to
							check their datasets for variety and to test their AI with
							different inputs to ensure it works for everyone. This mindset
							shift—from user to critical developer—is the core of AI ethics.
						</p>
					</section>
					...
					<section className="bg-primary/5 border border-primary/20 rounded-3xl p-8">
						...
						<p className="text-muted-foreground leading-relaxed mb-6">
							Our community of parents and educators is committed to raising the
							next generation of ethical tech leaders. Want to learn more about
							our approach?
						</p>
