...
const callsToAction = [
	{
		...
		body: "Introduce coding clubs, after-school programs, or weekend workshops in elementary school. Early wins build confidence that carries into high school course selections.",
	},
	{
		title: "Show Black excellence in tech",
		body: "Highlight Canadian innovators—think Claudette McGowan, Jean Augustine, or Saadia Muzaffar. Invite guest speakers who reflect the students you serve.",
	},
	{
		title: "Create mentorship pipelines",
		body: "Partner with Black professional networks (Obsidi, Black Professionals in Tech Network) to match students with mentors for project feedback and career chats.",
	},
	{
		title: "Support families with resources",
		body: "Offer bilingual guides, info nights, and scholarships. Parents who feel informed are more likely to champion STEM pathways at home.",
	},
];
				...
				<div className="max-w-3xl mx-auto">
					...
					<section className="space-y-6 mb-12">
						...
						<ul className="list-disc pl-6 text-muted-foreground space-y-3">
							...
							<li>
								Guidance counselling gaps: Reports from People for Education
								show Black students are less likely to be encouraged toward
								advanced math and science streams in high school.
							</li>
							<li>
					...
					<section className="space-y-6 mb-16">
						...
						<ul className="list-disc pl-6 text-muted-foreground space-y-3">
							...
							<li>
								<strong>
									Nova Scotia&apos;s Imhotep&apos;s Legacy Academy
								</strong>
