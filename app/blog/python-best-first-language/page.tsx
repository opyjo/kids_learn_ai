			...
			<article className="container mx-auto px-4 py-20 lg:py-28">
				<div className="max-w-3xl mx-auto">
					...
					<p className="text-muted-foreground text-lg leading-relaxed mb-10">
						When choosing a first programming language for children, the goal
						isn't just to learn syntax—it's to build a mental model of how
					...
					<section className="space-y-6 mb-12">
						...
						<p className="text-muted-foreground leading-relaxed">
							In many traditional languages, a simple "Hello World" program
							requires complex boilerplate code that can be intimidating for a
							beginner. In Python, it is exactly what you'd expect:{" "}
							<code>print("Hello World")</code>. This low barrier to entry keeps
							motivation high and allows kids to see immediate results from
							their effort.
						</p>
					</section>
					...
					<section className="space-y-6 mb-12">
						...
						<p className="text-muted-foreground leading-relaxed">
							When kids are learning to code, we want them to think about "How
							do I solve this puzzle?" rather than "Where did I forget a
							semicolon?" Python's use of whitespace and indentation forces good
							coding habits naturally, making the code easier to read and debug.
							This focus on logic is exactly what builds the foundation for AI
							literacy.
						</p>
					</section>
					...
					<section className="bg-secondary/30 rounded-3xl p-8 mb-16">
						<h2 className="text-2xl font-semibold mb-4">
							From Simple Scripts to AI Models
						</h2>
						<p className="text-muted-foreground leading-relaxed">
							The real magic of Python is its ceiling. While it's easy enough
							for a 10-year-old to write their first game, it's powerful enough
							to run the recommendation algorithms at Netflix or the data
							processing at NASA. By starting with Python, kids aren't just
							learning a "toy" language; they are gaining a professional skill
					...
					<section className="bg-primary/5 border border-primary/20 rounded-3xl p-8">
						...
						<p className="text-muted-foreground leading-relaxed mb-6">
							Our curriculum is designed to take kids from their very first line
							of code to building interactive AI projects. No prior experience
