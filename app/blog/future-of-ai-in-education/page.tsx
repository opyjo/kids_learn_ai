			...
			<article className="container mx-auto px-4 py-20 lg:py-28">
				<div className="max-w-3xl mx-auto">
					...
					<p className="text-muted-foreground text-lg leading-relaxed mb-10">
						The initial reaction to AI in schools was often fear of cheating.
					...
					<section className="space-y-6 mb-12">
						<h2 className="text-2xl font-semibold">
							Moving from 'Answer Machine' to 'Learning Coach'
						</h2>
						<p className="text-muted-foreground leading-relaxed">
							The true potential of AI isn't in giving students the right
							answer—it's in asking them the right questions. We are moving
							toward a world where every student has a tireless, 24/7 coach that
							helps them deconstruct complex Python errors or brainstorm new app
							ideas. This shift changes the role of the student from a passive
							receiver of information to an active manager of their own
							education.
						</p>
					</section>
					...
					<section className="space-y-6 mb-12">
						...
						<p className="text-muted-foreground leading-relaxed">
							AI will never replace the inspiration and empathy of a great
							teacher. Instead, it will handle the administrative and repetitive
							tasks—like grading syntax or generating practice exercises—freeing
							up educators to focus on mentoring, social-emotional support, and
					...
					<section className="bg-secondary/30 rounded-3xl p-8 mb-16">
						<h2 className="text-2xl font-semibold mb-4">
							Preparing for the 2030 Workplace
						</h2>
						<p className="text-muted-foreground leading-relaxed">
							The students of today will enter a workforce where 'AI
							collaboration' is a standard job requirement. By starting with
							Python and AI concepts now, they aren't just learning how to use a
							specific software—they are learning the language of the future
							economy.
						</p>
					</section>
					...
					<section className="bg-primary/5 border border-primary/20 rounded-3xl p-8">
						...
						<p className="text-muted-foreground leading-relaxed mb-6">
							Don't wait for the future to happen—help your child build it.
							Explore our AI-integrated curriculum and see how we're preparing
