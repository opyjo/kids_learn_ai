				...
				<Card className="rounded-none border-0 border-r border-slate-200 bg-transparent shadow-none dark:border-gray-800">
					<CardContent className="p-3">
						<div className="flex items-center justify-between">
							...
							<div className="flex h-7 w-7 items-center justify-center rounded-lg bg-green-50 dark:bg-green-950">
				...
				<Card className="rounded-none border-0 border-r border-slate-200 bg-transparent shadow-none dark:border-gray-800">
					<CardContent className="p-3">
						<div className="flex items-center justify-between">
							...
							<div className="flex h-7 w-7 items-center justify-center rounded-lg bg-purple-50 dark:bg-purple-950">
							...
							{recentStudents.map((student) => (
								...
								>
									<div className="flex items-center gap-3">
										<div className="flex h-7 w-7 items-center justify-center rounded-full bg-slate-100 text-sm font-semibold text-slate-700 dark:bg-slate-800 dark:text-slate-200">
