...
export default function AdminLayout({
	...
	return (
		<div className="min-h-screen bg-gray-50 dark:bg-gray-950">
			...
			<div className="flex">
				{/* Sidebar - Desktop */}
				<aside className="hidden lg:flex lg:flex-col lg:w-64 lg:shrink-0 lg:border-r lg:border-gray-200 dark:lg:border-gray-800 lg:bg-white dark:lg:bg-gray-900 lg:min-h-[calc(100vh-88px)]">
					{/* Navigation */}
