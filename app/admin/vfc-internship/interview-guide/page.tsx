	...
	return (
		<div className="space-y-3">
			...
			<div className="flex flex-wrap gap-2">
				...
				<Badge variant="secondary">Classes: Mon beginner · Wed Term 2</Badge>
			</div>
			...
			<Card className="border-0 shadow-sm bg-white dark:bg-gray-900">
				...
				<CardContent className="space-y-3 px-4 pb-4 pt-0">
					<ScriptBlock>
						...
						what you said about [specific detail]. Here's the shape of the next
						30 minutes: a bit about you, some Python questions, then I'll ask
						you to actually teach me something as if I were one of our students
						— that's the fun part. Then logistics and your questions. Sound
						good?&rdquo;
					</ScriptBlock>
					<ScriptBlock>
						&ldquo;The role is about ten hours a week — two hours a day, Monday
						to Friday. Mondays and Wednesdays you co-teach our live classes for
						kids aged 9 to 13, always with me present. The other three days are
						curriculum work: building exercises, testing lessons, prepping for
						new terms.&rdquo;
					</ScriptBlock>
				</CardContent>
			</Card>
			...
			<Card className="border-0 shadow-sm bg-white dark:bg-gray-900">
				<CardHeader className="px-4 py-3">
					...
					<CardDescription>
						The bar is fluent fundamentals, explained simply — variables, types,
						conditionals, loops, functions, lists. One explain-it-simply
						question plus the debugging read-aloud.
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4 px-4 pb-4 pt-0">
					...
					<div>
						...
						<p className="mb-2 text-sm text-gray-600 dark:text-gray-400">
							...
							<em>
								&ldquo;A student wrote this and says &lsquo;it's broken.&rsquo;
								Talk me through exactly what you'd say to them — to them, not to
								me.&rdquo;
							</em>
						</p>
						...
						<p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
							Two bugs: <code className="font-mono text-xs">=</code> instead of{" "}
							<code className="font-mono text-xs">==</code> on line 3, and
							concatenating a string with an int on line 6.{" "}
							<span className="font-semibold text-amber-700 dark:text-amber-500">
								Listen for:
							</span>{" "}
							do they guide the student to find it, or just announce the fix? Do
							they stay warm about the error? Announcing the answer is the
			...
			<Card className="border-0 shadow-sm bg-white dark:bg-gray-900">
				<CardHeader className="px-4 py-3">
					...
					<CardDescription>
						The highest-signal six minutes of the interview — protect it even if
						earlier sections ran long. One minute to think, four to teach, then
						a brief debrief.
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-3 px-4 pb-4 pt-0">
					<ScriptBlock>
						...
						learned about variables — nothing else. Take about four minutes and
						teach me what an if-statement is. You can talk, type, draw, whatever
						you'd actually do. Take a moment to think first if you like.&rdquo;
					</ScriptBlock>
			...
			<Card className="border-0 shadow-sm bg-white dark:bg-gray-900">
				...
				<CardContent className="space-y-3 px-4 pb-4 pt-0">
					<ScriptBlock>
						&ldquo;Here's what happens next: I'm finishing interviews this week.
						If we move forward, the next steps are reference checks and a
						vulnerable-sector check before any teaching, then onboarding and
			...
			<Card className="border-0 shadow-sm bg-white dark:bg-gray-900">
				<CardHeader className="px-4 py-3">
					...
					<CardDescription>
						...
						teaching instinct, or safeguarding comfort is a no regardless of the
						total.
					</CardDescription>
				</CardHeader>
				<CardContent className="px-4 pb-4 pt-0">
