...
description: "Learn to find and fix bugs in your code like a pro programmer!"
difficulty: "beginner"
order_index: 6
...
starter_code: |
  ...
  # Fix each bug and run the code!
class_activities: |
  **Activity: Bug Hunt!**
  
  1. Work in pairs
  2. One person writes code WITH a bug on purpose
  3. Partner tries to find and fix the bug
  4. Switch roles!
  
  **Debug Dance:**
  STOP → READ → FIND → THINK → FIX → TEST
take_home_assignment: |
  **Assignment: Debug Detective**
  
  Fix all the bugs in this code (there are 5 bugs!):
  ...
  Submit your fixed code on Trinket.
---
