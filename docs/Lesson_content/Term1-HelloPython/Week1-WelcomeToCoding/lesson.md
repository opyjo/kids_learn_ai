...
description: "Learn what programming is, meet Python, and write your very first code!"
difficulty: "beginner"
order_index: 1
...
class_activities: |
  **Activity: Hello Chain!**
  ...
  1. Each student writes their own "Hello" message
  2. Run the code and see the output
  3. Share your message with a partner
  4. Try making the computer say something funny!
take_home_assignment: |
  **Assignment: Three Facts About Me**

  Create a Python program that prints 3 facts about yourself:
  - Your name
  - Your favorite color
  - Your favorite game or hobby

  Submit your Trinket link to your instructor.
---

# Term 1, Week 1: Welcome to Coding! 🎉
