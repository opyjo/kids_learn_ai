...
starter_code: |
  ...
  # Let's build a class program together!

  # Step 1: Say hello to the world
  print("Hello, World!")

  # Step 2: Tell us your name (replace YOUR NAME with your real name)
  print("My name is [YOUR NAME]!")

  # Step 3: Share something you love (replace YOUR THING)
  print("I love [YOUR THING]!")

  # Step 4: Add a fun fact with an emoji!
  print("Fun fact: [YOUR FACT] 🎉")

  # Bonus: Add more print lines below!

class_activities: |
  ## 🎮 Class Activity: Hello Chain!

  Let's build a class program together! Open the **Code Editor** (button at the bottom right) and follow along.

  ### Instructions

  1. Click **Run** to see what happens — you should see "Hello, World!" appear in the output
  2. Find where it says **YOUR NAME** and replace it with your real name
  3. Click **Run** again — can you see your name on the screen?
  4. Now find **YOUR THING** and replace it with something you love — it could be football, drawing, gaming, cooking, anything!
  5. Find **YOUR FACT** and replace it with a fun fact about yourself
  6. Click **Run** to see your full program

  ### Bonus Challenge
  - Add more lines to your program! Can you add your age? Your favourite food? Your dream job?
  - Try adding an emoji to each line
  - When you're finished, share your favourite line in the Zoom chat!
take_home_assignment: |
  ...
  **Requirements:**
  ...
  4. Use at least one emoji in a print statement

  **Example:**
  ```python
  print("Hi! My name is Kofi.")
  print("I am 11 years old.")
  print("I love playing chess.")
  print("Fun fact: I have a pet tortoise 🐢")
...
ai_activities: |
  ...
  Think about your day so far. Have you used any of these?

  - 📱 Asked Siri or Google Assistant a question?
  - 🎵 Listened to music that was recommended to you?
  - 🎮 Played a video game where enemies react to you?
  - 📸 Unlocked a phone with your face?

  **Discuss with a partner:** "What AI did you use today, and how did it help you?"

  All of these are powered by code — just like what you're about to learn!
---
...
> **Think about your morning. What AI did you interact with?**
> Type your answer in the **Zoom chat** or unmute and share with the class!
...
|---|---|
| 🔍 Google | Search engine and AI research |
| 📸 Instagram | Running the app for 2 billion users |
| 🚀 NASA | Analysing space data |
| 🎮 Game studios | Building games and simulations |
| 🤖 AI researchers | Building tools like ChatGPT |
...
**Step 1: Stay on the Zoom call**
Keep your Zoom window open — your teacher will walk you through every step by sharing their screen. Follow along on your own device at the same time.
...
## 🖥️ Part 4: Your First Python Program!
...
🎉 **Congratulations — you are officially a programmer!**
...
> **Think of `print()` like a megaphone 📣** — whatever you put inside, Python shouts it onto the screen!
...
print("Today is my first coding lesson!")
```

Click **▶ Run** and see all four lines appear!
...
```python
print("I love maths!")
print("My favourite food is jollof rice 🍚")
print("One day I will build an app!")
print("Python is cooler than I expected!")
```
...
```python
print("My name is Sofia and I love art! 🎨")
...
When the full program runs — react on Zoom! 🎉
...
> *"Today, you took your very first step into the world of coding. Every great programmer — every AI engineer, every app developer — started exactly where you are right now. You should be incredibly proud!"*
> — BrightByte 🤖
