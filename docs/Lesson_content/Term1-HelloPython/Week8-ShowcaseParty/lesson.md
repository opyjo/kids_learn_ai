...
description: "Celebrate your accomplishments and present your Joke Machine project!"
difficulty: "beginner"
order_index: 8
...
starter_code: |
  # Showcase Party!
  # Get your Joke Machine ready to present!
  
  # Presentation Checklist:
  # ✅ Does your program run without errors?
  # ✅ Does it have a welcome message?
  # ✅ Does it have at least 3 jokes?
  # ✅ Does it have an ending message?
  
  # Practice running your code before presenting!
class_activities: |
  **Today's Schedule:**
  
  1. **Final Polish (15 min)** - Last chance to fix bugs!
  2. **Presentations (30 min)** - Show off your Joke Machine
  3. **Awards & Celebration (10 min)** - Everyone gets a certificate!
  4. **Term 2 Preview (5 min)** - What's coming next!
  
  **Presentation Tips:**
  - Introduce yourself and your project
  - Run your program start to finish
...
take_home_assignment: |
  **Reflection Assignment:**
  ...
  1. What was your FAVORITE thing you learned in Term 1?
  2. What was the HARDEST thing?
  3. What are you MOST PROUD of?
  4. What do you want to learn in Term 2?
  
  Share your answers with your instructor!
---
