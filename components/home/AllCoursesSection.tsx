...
export const AllCoursesSection = async () => {
	...
	return (
		<section className="container mx-auto px-4 py-20 lg:py-28 bg-gradient-to-b from-transparent via-primary/5 to-transparent">
			<div className="max-w-7xl mx-auto">
				...
				<div className="text-center mb-12">
					...
					<p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
						{user
							...
							: "Sign in to track your progress and access enrolled levels"}
					</p>
				</div>

				{/* Levels by Year */}
				{Object.entries(coursesByYear).map(([yearGroup, courses]) => (
					<div key={yearGroup} className="mb-12">
												...
												<div className="flex-1 min-w-0">
													<div className="flex items-start justify-between gap-2 mb-2">
														...
														{isComingSoon && (
															<Badge
																variant="outline"
																className="text-yellow-600 border-yellow-300 text-xs shrink-0"
															>
																Coming Soon
															</Badge>
														)}
				...
				{user && totalEnrolled === 0 && (
					<Card className="mt-12 border-accent/30 bg-gradient-to-r from-accent/5 to-primary/5">
						<CardContent className="p-6 text-center">
							<h3 className="text-lg font-bold text-foreground mb-2">
								Start Your Coding Journey Today!
							</h3>
							<p className="text-muted-foreground mb-4">
								Request a free trial spot and discover the joy of learning to
								code.
							</p>
				...
				{!user && (
					<Card className="mt-12 border-primary/30 bg-gradient-to-r from-primary/5 to-accent/5">
						<CardContent className="p-6 text-center">
							<h3 className="text-lg font-bold text-foreground mb-2">
								Track Your Progress
							</h3>
