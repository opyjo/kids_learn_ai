	...
	return (
		<div className="flex flex-col gap-3 sm:w-72">
			<div className="flex items-center gap-2">
				...
				>
					<SelectTrigger className="h-9" aria-label="Application status">
						<SelectValue />
					</SelectTrigger>
					<SelectContent>
			...
			{hasResume && (
				<a
					href={`/api/admin/applications/${id}/resume`}
					className="inline-flex items-center gap-2 rounded-md border px-3 py-2 text-sm font-medium text-blue-600 hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-blue-950/30"
				>
			...
			<Textarea
				...
				placeholder="Internal notes (interview date, impressions…)"
				rows={2}
				className="text-sm"
